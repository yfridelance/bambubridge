...
# Home Assistant MQTT integration (Discovery + tray-issue events).
# Publishes AMS tray issues to a separate Home Assistant MQTT broker so HA
# automations can trigger notifications. Read-only from BambuBridge's side.
HA_MQTT_ENABLED = _env_to_bool("BAMBUBRIDGE_HA_MQTT_ENABLED", False, "OPENSPOOLMAN_HA_MQTT_ENABLED")
HA_MQTT_HOST = _env("BAMBUBRIDGE_HA_MQTT_HOST", "OPENSPOOLMAN_HA_MQTT_HOST") or ""
HA_MQTT_PORT = _env_to_int("BAMBUBRIDGE_HA_MQTT_PORT", 1883, "OPENSPOOLMAN_HA_MQTT_PORT")
HA_MQTT_USER = _env("BAMBUBRIDGE_HA_MQTT_USER", "OPENSPOOLMAN_HA_MQTT_USER") or ""
HA_MQTT_PASSWORD = _env("BAMBUBRIDGE_HA_MQTT_PASSWORD", "OPENSPOOLMAN_HA_MQTT_PASSWORD") or ""
HA_MQTT_TLS = _env_to_bool("BAMBUBRIDGE_HA_MQTT_TLS", False, "OPENSPOOLMAN_HA_MQTT_TLS")
HA_MQTT_DISCOVERY_PREFIX = _env("BAMBUBRIDGE_HA_MQTT_DISCOVERY_PREFIX", "OPENSPOOLMAN_HA_MQTT_DISCOVERY_PREFIX") or "homeassistant"
HA_MQTT_BASE_TOPIC = _env("BAMBUBRIDGE_HA_MQTT_BASE_TOPIC", "OPENSPOOLMAN_HA_MQTT_BASE_TOPIC") or "bambubridge"
PUBLIC_URL = _env("BAMBUBRIDGE_PUBLIC_URL", "OPENSPOOLMAN_PUBLIC_URL") or ""
